...
const BASE_URL = "https://caracas-caravan-club.lovable.app";
...
const entries: SitemapEntry[] = [
  ...
  { path: "/conviertete-en-anfitrion", changefreq: "monthly", priority: "0.8" },
  ...
  { path: "/politica-cancelacion", changefreq: "yearly", priority: "0.3" },
];
